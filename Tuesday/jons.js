...
/*========== I moved this to where it lists above our question =============*/
//This function makes my list appear in the console
function makeList() {
  connection.query("SELECT * FROM products", function (err, res) {
    console.table(res);
    /*==== vvvv === I put this in here so it calls at the right time =============*/
    makePurchase(res);
  });
}
...
/* ====We have to pass the vvv products to the makePurchase function ====*/ 
